...
from database import setup_database, save_event_to_db, get_events_for_month, update_event_in_db, delete_event_from_db
...
# Initialize database and load calendar
setup_database()
